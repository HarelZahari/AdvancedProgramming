...
public class DNSResolver {
    ...
    /**
     * Read a name, in the DNS Resource-record (RR) format supporting the DNS
     * compression scheme. (see RFC 1035 for details)
     * 
     * @param name
     *            The StringBuilder into which the name will be written (if not
     *            null)
     * @param origBuf
     *            The buffer from which the name should be read (it will be
     *            appended)
     * @param offset
     *            The offset in the buffer at which the name starts.
     * @return the number of bytes read from the buffer.
     * @throws IOException
     *             (in case the name is badly formatted)
     */
    ...
    /**
     * Query a DNS nameserver for a hostname and return the corresponding IP
     * address.
     *
     * (you can use {@link InetAddress#getByAddress} to generate an
     * {@link InetAddress} object).
     *
     * You may assume the hostname and nameserver actually exist (you don't have to
     * handle I/O errors).
     *
     * @param hostname
     * @param nameServer
