...
public abstract class PersistentDictionaryTest {
     ...
     * Subclasses should override this method to return a concrete
     * PersistentDictionary.
     * 
     * @param name
     * @return
    ...
    String[] testDefs = { "Some definition", "another definition", "", "yet another definition", "lorem ipsum dolor",
            "", "- ? d  ddd cccc e" };

    String[] addWords = { "Second", "Third", "AAAA", "CAB" };

    String[] addDefs = { "A completely different definition", "1 2 3", "BBBB", "yahoo!", };

    /**
     * Fill a dictionary with words. Any class with a "put(String,String)" method is
     * supported as a dictionary.
     * 
     * @param dict
     ...
     *            length as words).
     * @throws Exception
     *             may throw a reflection-related exception if dict is not a valid
     *             dictionary or an IOException if dict.put does.
     */
    ...
    /**
     * Compare a Java map to a dictionary. Checks that the sizes are the same, then
     * iterates over all keys in the map and compares the values.
     * 
     * @param map
     * @param dict
     * @return
